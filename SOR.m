...
for i = 1:nV
    for j = 1:nd
        ...
        while iter < max_iter
            ...
            V_gs = (1/Y_bus(k,k)) * ( (conj(S_spec(k))/conj(Vk_old)) - sum_term );

            % Apply SOR relaxation
            V(k) = Vk_old + omega * (V_gs - Vk_old);
...
ylabel('v_2 [pu]')
if addTitle
    title('Region of Attraction of SOR Method')
end
...
saveas(gcf, 'SOR-RegionOfAttraction.png');
